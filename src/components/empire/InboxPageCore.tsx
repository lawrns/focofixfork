...
const typeColors: Record<NotificationType, string> = {
  ...
  assigned: 'text-[color:var(--foco-teal)] bg-secondary dark:bg-secondary',
  ...
  return (
    <div
      className={cn(
        ...
        !item.isRead && 'bg-secondary/30 dark:bg-secondary/20'
      )}
    >
      <Checkbox
        checked={selected}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {!item.isRead && (
              <div className="h-2 w-2 rounded-full bg-secondary0" />
            )}
          </div>
        </div>
      </div>
