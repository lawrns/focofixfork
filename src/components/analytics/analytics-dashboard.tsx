    ...
    try {
      ...
      if (!data) {
        ...
        setAnalytics({
          ...
          milestones: {
            totalMilestones: 87,
            completedMilestones: 65,
            overdueMilestones: 8,
            milestoneCompletionRate: 74.7,
            averageMilestoneDuration: 12
          },
          tasks: {
            totalTasks: 342,
            completedTasks: 289,
            ...
            tasksByPriority: { high: 45, medium: 89, low: 156, urgent: 52 },
            tasksByStatus: { todo: 53, in_progress: 67, completed: 289, cancelled: 8 }
          },
          timeTracking: {
            ...
            projectHours: [
              ...
              { projectId: 'proj-3', name: 'Dashboard UI', hours: 167.8 }
            ]
          },
          team: {
            totalMembers: 12,
          ...
          trends: {
            ...
            taskCompletionTrend: [78, 80, 82, 84, 85, 87],
            teamProductivityTrend: [82, 83, 84, 85, 86, 87]
          },
          period: {
      ...
      setAnalytics({
        ...
        milestones: {
          ...
          overdueMilestones: 5,
          milestoneCompletionRate: 73.8,
          averageMilestoneDuration: 10
        },
        tasks: {
          totalTasks: 256,
          completedTasks: 218,
          ...
          tasksByPriority: { high: 32, medium: 67, low: 124, urgent: 33 },
          tasksByStatus: { todo: 38, in_progress: 52, completed: 218, cancelled: 6 }
        },
        timeTracking: {
          ...
          projectHours: [
            ...
            { projectId: 'proj-3', name: 'Dashboard UI', hours: 134.8 }
          ]
        },
        team: {
          totalMembers: 9,
        ...
        trends: {
          ...
          taskCompletionTrend: [75, 77, 79, 81, 83, 85],
          teamProductivityTrend: [80, 81, 82, 83, 84, 85]
        },
        period: {
          startDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
          endDate: new Date().toISOString()
