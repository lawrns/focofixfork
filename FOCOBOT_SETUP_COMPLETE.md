...
✅ TWILIO_WHATSAPP_NUMBER=+15557170836
```
...
3. **Configure Webhook for your number (+15557170836):**
...
- Or admin can manually delete in Supabase:
  ```sql
  DELETE FROM whatsapp_user_links WHERE phone = '+15557170836';
  ```
