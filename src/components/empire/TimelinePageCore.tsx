...
export function TimelinePageCore({ pageTitle = 'Timeline' }: { pageTitle?: string }) {
  ...
  const [currentMonthIndex, setCurrentMonthIndex] = useState(nowMonth);
  ...
  return (
    <div className="max-w-full">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isToday && 'bg-secondary dark:bg-secondary/30'
                  )}
                >
                  ...
                  <div className={cn(
                    'text-xs font-medium',
                    isToday ? 'text-[color:var(--foco-teal)]' : 'text-zinc-600 dark:text-zinc-300'
                  )}>
                    {date.getDate()}
                  </div>
                </div>
          ...
          <div key={projectName}>
            <div className="flex border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/50">
              ...
              <div className="flex-1 relative">
                <div
                  className="absolute top-0 bottom-0 w-0.5 bg-secondary0 z-10"
      ...
      <div className="flex items-center gap-6 mt-4 text-xs text-zinc-500">
        ...
        <div className="flex items-center gap-2">
          <div className="h-3 w-0.5 bg-secondary0" />
          <span>Today</span>
        </div>
