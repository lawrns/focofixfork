...
// Dynamic imports for heavy components - reduces initial bundle by ~18MB
const ProjectTable = dynamic(() => import('@/features/projects/components/ProjectTable'), {
  loading: () => <div className="h-96 flex items-center justify-center">Loading projects...</div>,
  ssr: false
})

const ProjectList = dynamic(() => import('@/features/projects').then(mod => ({ default: mod.ProjectList })), {
  loading: () => <div className="h-96 flex items-center justify-center">Loading projects...</div>,
  ssr: false
})

const ProjectForm = dynamic(() => import('@/features/projects').then(mod => ({ default: mod.ProjectForm })), {
  ssr: false
})

const ProjectCreationModal = dynamic(() => import('@/components/projects/project-creation-modal').then(mod => ({ default: mod.ProjectCreationModal })), {
  ssr: false
})

const ImportExportModal = dynamic(() => import('@/components/import-export/import-export-modal').then(mod => ({ default: mod.ImportExportModal })), {
  ssr: false
})

const AIProjectCreator = dynamic(() => import('@/components/ai/ai-project-creator').then(mod => ({ default: mod.AIProjectCreator })), {
  ssr: false
})
