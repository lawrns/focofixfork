-- Fix RLS policies for projects tables
-- This script completely resets and recreates RLS policies for projects
...
-- Recreate all policies for project_team_assignments table
