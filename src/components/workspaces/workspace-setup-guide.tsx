  ...
  return (
    ...
    >
      <StudioSurface
        tone="soft"
        padding="md"
        className={cn(compact ? "border-border/30" : "border-border/50")}
      >
        <div className="relative flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <StudioHeader
            eyebrow="How it works"
            eyebrowClassName="tracking-[0.24em]"
            title="Give the workspace a job, approve the first draft, and keep improving the system over time."
            description="The assistant should help you turn intent into structure, then turn repeated work into trusted automation."
          />
